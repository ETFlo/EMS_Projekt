...
def simulate(bat1_max_charge, bat1_max_discharge, bat2_max_charge, bat2_max_discharge, battery_low_weight, battery_high_weight, battery_low_exp, battery_high_exp, scaling_PV = 1, scaling_LAST = 1, PLOTTING = True, zeit = 1):
    ...
    pv_1_data = pv_battery_model.pv_scale(pv_1_raw_data, 50*scaling_PV) / 1000
    pv_2_data = pv_battery_model.pv_scale(pv_2_raw_data, 30*scaling_PV) / 1000
    pv_3_data = pv_battery_model.pv_scale(pv_3_raw_data, 20*scaling_PV) / 1000
    """ -------- """
    ...
    last1 = 10 * load_data["H0-A_pload"].values / 1000 *scaling_LAST
    last2 = 20 * load_data["G2-A_pload"].values / 1000 *scaling_LAST
    last3 = 15 * load_data["H0-B_pload"].values / 1000 *scaling_LAST
    last4 = 10 * load_data["G3-A_pload"].values / 1000 *scaling_LAST
    """ --------- """
    ...
    if zeit == 1:
        ...
        spanne = range(15000, 15600)
    elif zeit == 3:
        spanne = range(24000, 24600)
    for t in spanne:
        # PV-Daten zuweisen
...
if __name__ == "__main__":
    ...
    #no_battery = simulate(0, 0, 0, 0, 0, 0, 0, 0, 0)
    ...
    #overstepping_voltage = simulate(4.758e+01 , 2.847e+01 , 2.330e+01  ,7.205e+00,  5.220e-01,  1.704e-01,  5.831e+00 , 3.784e+00, 0)  # Differential-Evolution Verfahren t -> 15000 - 15600 popsize = 5 
    ...
    ##########
    no_battery = simulate(0, 0, 0, 0, 0, 0, 0, 0, 0.99609375, 0.5)
    print(no_battery)
    #overstepping_voltage = simulate(4.758e+01 , 2.847e+01 , 2.330e+01  ,7.205e+00,  5.220e-01,  1.704e-01,  5.831e+00 , 3.784e+00, 0, 0.5)  # Differential-Evolution Verfahren t -> 15000 - 15600 popsize = 5 
