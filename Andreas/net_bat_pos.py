...
def simulate(bat1_max_charge, bat1_max_discharge, bat2_max_charge, bat2_max_discharge, battery_low_weight, battery_high_weight, battery_low_exp, battery_high_exp):
    ...
    """ PV DATEN """
    # PV Daten einlesen
    filename_pv = "C:/Users/andre/Desktop/MEE/Semester 1/EMS-Project/GIT-repository/EMS_Projekt/Flo/files/RESProfile.csv"  # Daten liegen in 1/4 h Zeitschritten vor
    ...
    #filename_pv = "C:\Users\andre\Desktop\MEE\Semester 1\EMS-Project\GIT-repository\EMS_Projekt\Flo\files/pv_1kWp.csv"   # Daten liegen in Stundenzeitschritten vor
    ...
    """ LAST DATEN """
    #Last Daten einlesen
    filename_load = "C:/Users/andre/Desktop/MEE/Semester 1/EMS-Project/GIT-repository/EMS_Projekt/Flo/files/LoadProfile.csv"  # Daten liegen in 1/4 h Zeitschritten vor
    ...
    """ BATTERIE """
    b_1_2_2_1 = pv_battery_model.Battery(SoC = 1000/1000, max_capacity = 2000/1000, max_charge = bat1_max_charge / 1000, max_discharge = bat1_max_discharge / 1000)
    b_2_2_1_1 = pv_battery_model.Battery(SoC = 1000/1000, max_capacity = 2000/1000, max_charge = bat2_max_charge / 1000, max_discharge = bat2_max_discharge / 1000)
    """ --------- """
    ...
    for t in range(600):
        ...
        if(net.res_bus.at[v2_2_2_2, "vm_pu"] > 1.025):
            #pv_power = b_2_2_1_1.charge_quarter(pv_4_data_x[t] * 1/4) * 4
            pv_power = b_2_2_1_1.charge(pv_4_data_x[t],1/4)
            net.sgen.at[e_2_2_2_2, "p_mw"] = abs(pv_power)
            pp.runpp(net)
        elif(net.res_bus.at[v2_2_2_2, "vm_pu"] < 0.975):
            #pv_power = b_2_2_1_1.charge_quarter(-b_2_2_1_1.max_discharge * 1/4) * 4
            #pv_power = b_2_2_1_1.max_discharge * 1/4 - remaining_pv
            #pv_power = pv_power + b_2_2_1_1.charge(-2, 1/4)
            pv_power = pv_power + abs(b_2_2_1_1.charge(-b_2_2_1_1.max_discharge, 1/4))
            net.sgen.at[e_2_2_2_2, "p_mw"] = pv_power
            pp.runpp(net) 
        """

        
        battery_action1 = battery_control(net.res_bus.at[v1_2_2_1, "vm_pu"], b_1_2_2_1.SoC / b_1_2_2_1.max_capacity, battery_low_weight, battery_high_weight, battery_low_exp, battery_high_exp)
        battery_action2 = battery_control(net.res_bus.at[v2_2_1_1, "vm_pu"], b_2_2_1_1.SoC / b_2_2_1_1.max_capacity, battery_low_weight, battery_high_weight, battery_low_exp, battery_high_exp)

        if(battery_action1 > 0):                                
            net.sgen.at[e_1_2_2_1, "p_mw"] = net.sgen.at[e_1_2_2_1, "p_mw"] - b_1_2_2_1.charge(battery_action1*b_1_2_2_1.max_charge, 1/4)
        else:
            net.sgen.at[e_1_2_2_1, "p_mw"] = net.sgen.at[e_1_2_2_1, "p_mw"] - b_1_2_2_1.charge(battery_action1*b_1_2_2_1.max_discharge, 1/4)

        if(battery_action2 > 0):
            net.sgen.at[e_2_2_1_1, "p_mw"] = net.sgen.at[e_2_2_1_1, "p_mw"] - b_2_2_1_1.charge(battery_action2*b_2_2_1_1.max_charge, 1/4)
        else:
            net.sgen.at[e_2_2_1_1, "p_mw"] = net.sgen.at[e_2_2_1_1, "p_mw"] - b_2_2_1_1.charge(battery_action1*b_2_2_1_1.max_discharge, 1/4)
        ...
        results_battery.append({
            "time": t,
            "SoC_battery_b_1_2_2_1": b_1_2_2_1.SoC,
            "SoC_battery_b_2_2_1_1": b_2_2_1_1.SoC
        })
    ...
    #results_df.to_csv("C:/Users/andre/Desktop/MEE/Semester 1/EMS-Project/GIT-repository/EMS_Projekt/Andreas/typical_pv_results.csv", index=False)
    ...
    plt.plot(results_battery_df["time"], results_battery_df["SoC_battery_b_1_2_2_1"], label="SOC_battery_b_1_2_2_1")
    plt.plot(results_battery_df["time"], results_battery_df["SoC_battery_b_2_2_1_1"], label="SOC_battery_b_2_2_1_1")
...
if __name__ == "__main__":
    ...
    overstepping_voltage = simulate(3.193e+01, 1.817e+01, 6.666e+00, 1.294e+01, 2.615e-02, 5.538e-01, 8.885e+00, 8.338e-01) # opt für Winter ganz außen
    overstepping_voltage = simulate(4.717e+01, 3.160e+01, 2.639e+01, 4.955e+00, 6.798e-01, 4.088e-01, 4.770e+00, 4.862e+00) # opt für Sommer ganz außen
    


    overstepping_voltage = simulate(3.947e+01, 2.242e+01, 1.933e+01, 1.854e+01, 3.554e-01, 7.450e-01, 8.860e+00, 3.149e-01) # opt für Winter eines weiter innen
    overstepping_voltage = simulate(6.728e+01, 3.600e+01, 4.464e+01, 1.659e+01, 6.980e-01, 2.510e-01, 2.371e-01, 5.520e+00) # opt für Sommer eines weiter innen



    overstepping_voltage = simulate(5.465e+01, 3.258e+01, 3.679e+01, 1.320e+01, 4.631e-01, 6.995e-01, 3.795e+00, 3.877e-01) # opt für Winter zweiter Knotenpunkt
    overstepping_voltage = simulate(7.224e+01, 4.425e+01, 6.211e+01, 2.359e+01, 2.342e-01, 6.108e-01, 3.392e-01, 9.102e+00) # opt für Sommer zweiter Knotenpunkt
