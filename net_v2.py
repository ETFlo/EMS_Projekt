...
""" PV DATEN """
# PV Daten einlesen
filename_pv = "./Data/RESProfile.csv"  # Daten liegen in 1/4 h Zeitschritten vor
...
""" LAST DATEN """
#Last Daten einlesen
filename_load = "./Data/LoadProfile.csv"  # Daten liegen in 1/4 h Zeitschritten vor
...
plotfunktion.spannungsplot(net, results_df, 2000)
